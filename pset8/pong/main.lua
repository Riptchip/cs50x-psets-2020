...
function love.load()
    ...
    player1 = Paddle(10, 30, 5, 20, 1, 1)
    player2 = Paddle(VIRTUAL_WIDTH - 15, VIRTUAL_HEIGHT - 30, 5, 20, 1, 2)
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball:collides(player1) then
            ...
            player2:calculate(ball.dx, ball.dy, ball.x, ball.y, 2)
        end
        if ball:collides(player2) then
            ...
            sounds['paddle_hit']:play()
            player1:calculate(ball.dx, ball.dy, ball.x, ball.y)
        end
